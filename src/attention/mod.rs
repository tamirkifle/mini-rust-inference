...
pub use cached::{cached_attention_decode, cached_attention_prefill}; // CHANGED: commit 9.2
pub use gqa::{
    // CHANGED: commit 7.4
...
pub use multihead::{
    concat_heads, multi_head_attention, multi_head_attention_causal,
    multi_head_attention_causal_with_offset, split_head,
};
pub use sdpa::scaled_dot_product_attention;
pub use sliding::{sliding_window_gqa, sliding_window_mask, sliding_window_sdpa}; // commit 12.3
