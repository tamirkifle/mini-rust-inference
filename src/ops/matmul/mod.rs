...
//! | `blocked`     | Cache-tiled GEMM; 64×64 aarch64 / 32×32 x86   | 5.2    |
//! | `neon_f32`    | Explicit NEON vfmaq_f32 f32 GEMM (aarch64)     | 18.5   |
//! | `parallel`    | Row-parallel GEMM via rayon; INT8 parallel     | 12.2, 16.3 |
